...
local function ExtensionsMainLayer()
    ...
    if (cc.PLATFORM_IPHONE == targetPlatform) or (cc.PLATFORM_IPAD == targetPlatform) or (cc.PLATFORM_ANDROID == targetPlatform) or (cc.PLATFORM_WINDOWS == targetPlatform) or (cc.PLATFORM_MAC == targetPlatform) then
        bSupportWebSocket = true
    end
    local bSupportEdit = false
    if (cc.PLATFORM_IPHONE == targetPlatform) or (cc.PLATFORM_IPAD == targetPlatform) or 
        (cc.PLATFORM_ANDROID == targetPlatform) or (cc.PLATFORM_WINDOWS == targetPlatform) or 
        (cc.PLATFORM_MAC == targetPlatform) then
        bSupportEdit = true
    end
