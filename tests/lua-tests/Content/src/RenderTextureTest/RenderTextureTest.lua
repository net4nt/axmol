    ...
    local function onTouchesMoved(touches, event)
        ...
        if distance > 1 then
            ...
            for i = 0,d -1 do
                ...
                sprite:setColor(ax.c3b(255, 0, 0))
            ...
            for i = 0,d -1 do
                ...
                brushes[i + 1]:setColor(ax.c3b(math.random(0, 126) + 128, 255, 255))
...
--     */
--     local background = ax.LayerColor:create(ax.c4b(200,200,200,255))
--     addChild(background)
...
--     sprite:setScale(10)
--     local rend = ax.RenderTexture:create(s.width, s.height, kax.Texture2DPixelFormat_RGBA4444, GL_DEPTH24_STENCIL8)
...
--         *  B2: non-premulti render
--     */
--     local background = ax.LayerColor:create(ax.c4b(40,40,40,255))
--     addChild(background)
...
--     local renderTexture = ax.RenderTexture:create(s.width, s.height, kax.Texture2DPixelFormat_RGBA4444)
...
--     renderTexture:setClearColor(ax.c4f(0, 0, 0, 0))
...
--     renderTexture:setClearColor(ax.c4f( ax.RANDOM_0_1(), ax.RANDOM_0_1(), ax.RANDOM_0_1(), 1))
--     end
-- end
